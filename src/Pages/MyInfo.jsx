...
function MyInfo() {
  ...
  return (
    <section className="om-mig">
      <div className="om-mig-box" style={{ display: "flex", justifyContent: "center" }}>
        <StyledWrapper>
          <div className="main">
            <div className="card" onClick={() => openSocial("https://www.instagram.com")} title="Instagram">
            ...
            <div className="card" onClick={() => openSocial("https://x.com")} title="X (Twitter)">
            ...
            <div className="card" onClick={() => openSocial("https://dribbble.com")} title="Dribbble">
            ...
            <div className="card" onClick={() => openSocial("https://codepen.io")} title="CodePen">
            ...
            <div className="card" onClick={() => openSocial("https://uiverse.io")} title="Uiverse">
            ...
            <div className="card" onClick={() => openSocial("https://discord.com")} title="Discord">
            ...
            <div className="card" onClick={() => openSocial("https://github.com")} title="GitHub">
            ...
            <div className="card" onClick={() => openSocial("https://t.me")} title="Telegram">
            ...
            <div className="card" onClick={() => openSocial("https://www.reddit.com")} title="Reddit">
